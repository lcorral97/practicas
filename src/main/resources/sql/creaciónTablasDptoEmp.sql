...
Insert into empleados(nDIEmp, nomEmp, sexEmp, fecNac, fecIncorporacion, salEmp, cargoE, comisionE,ciudad,password) values ('AA0001','Juan Garcia', 'V', '1985-02-07', '1999-11-17', 35000, 'Director', 1500, 'Madrid', 'JGAA');
...
Insert into empleados(nDIEmp, nomEmp, sexEmp, fecNac, fecIncorporacion, salEmp, cargoE, comisionE,ciudad,password) values ('IN0001','Alvaro Calvo', 'V', '1987-05-22', '2002-08-13', 32400, 'Jefe Inf.', 1000, 'Madrid', 'ACIN');
...
Insert into empleados(nDIEmp, nomEmp, sexEmp, fecNac, fecIncorporacion, salEmp, cargoE, comisionE, codDepto, ciudad,password) values ('IN0003','Marta Marquez', 'M', '1977-12-12', '1999-11-30', 27500, 'Trabajador', 700, '2000','Madrid', 'MMIN');
Insert into empleados(nDIEmp, nomEmp, sexEmp, fecNac, fecIncorporacion, salEmp, cargoE, comisionE, codDepto, ciudad,password) values ('IN0004','Jose Carlos Alcantara', 'V', '1998-01-11', '2000-12-12', 26000, 'Trabajador', 500, '2000','Leganes', 'JCAIN');
Insert into empleados(nDIEmp, nomEmp, sexEmp, fecNac, fecIncorporacion, salEmp, cargoE, comisionE, codDepto, ciudad,password) values ('IN0005','Sara Ferres', 'M', '1989-02-10', '2012-05-27', 23000, 'Secretaria', 800, '2000','Fuenlabrada', 'SFIN');
Insert into empleados(nDIEmp, nomEmp, sexEmp, fecNac, fecIncorporacion, salEmp, cargoE, comisionE, ciudad,password) values ('MK0001','Ainhoa Liebana', 'M', '1985-10-05', '2000-10-14', 30750, 'Jefe Mark.', 950, 'Barcelona', 'ALMK');
...
Insert into empleados(nDIEmp, nomEmp, sexEmp, fecNac, fecIncorporacion, salEmp, cargoE, comisionE, codDepto, ciudad,password) values ('MK0004','Juan Jose Sabater', 'V', '1966-01-14', '1999-12-23', 27000, 'Secretaria', 650, '3000', 'Barcelona', 'JJSMK');
Insert into empleados(nDIEmp, nomEmp, sexEmp, fecNac, fecIncorporacion, salEmp, cargoE, comisionE, codDepto, ciudad,password) values ('MK0005','Anais Valtiere', 'M', '1996-08-15', '2009-09-14', 24500, 'Secretaria', 700, '3000', 'Tarragona', 'AVMK');
...
Insert into empleados(nDIEmp, nomEmp, sexEmp, fecNac, fecIncorporacion, salEmp, cargoE, comisionE, codDepto, ciudad,password) values ('RH0002','Maria de la Rosa', 'M', '1994-11-05', '2000-10-11', 24550, 'Trabajador', 880, '4000', 'Valencia', 'MdlRRH');
Insert into empleados(nDIEmp, nomEmp, sexEmp, fecNac, fecIncorporacion, salEmp, cargoE, comisionE, codDepto, ciudad,password) values ('RH0003','Sergio Calvia', 'V', '1998-03-11', '2010-10-20', 25500, 'Secretaria', 650, '4000', 'Valencia', 'SCRH');
